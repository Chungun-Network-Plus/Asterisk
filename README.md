...
| ![](assets/stylus모드.png) | :   | ppt에 포인터, 선, 지우개, 제스처 쓸 수 있습니다. 발표시에는 디스플레이 복제해야 동작합니다. 와이파이가 정보 보내는 속도가 느려서 와이파이 성능보다 빠른 동작은.. 인식을 못할 가능성이 높습니다... 제스처는 사방면으로 가능한데 직접 해보시면서 기능을 알아맞춰보세요^^ |
| -------------------------- | --- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
